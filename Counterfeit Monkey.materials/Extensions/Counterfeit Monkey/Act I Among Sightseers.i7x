...
The marble fountain is a scenery container. It is in Park center. The description of the fountain is "[if horses are part of the marble fountain]It depicts [end if][if boldening is true and horses are part of the marble fountain][bold type][end if][if horses are part of the marble fountain]some horses[roman type] rising out of the waves, with trident-bearing gods on their backs, and some nymphs overseeing the whole operation. Probably 17th-century, to judge by the excessive number of writhing [figures][else if hoses are part of the marble fountain]The nymphs and trident-bearing gods are now aiming [hoses] out at passers-by[else if hoe is part of the marble fountain]A single bewildered nymph is carrying a [hoe], which presumably isn't much use out at sea[else]The former majesty of the fountain has been extensively vandalized[end if]."
...
"Secession Day" or "secession"	"The secession of Atlantis from British governance in 1822 culminated in the reduction of the attacking British fleet on April 19. The holiday celebrates this occasion, which is considered the beginning of Atlantean self-rule."
