...
why gift shop volunteer seems here is a questioning quip.
	...
	Understand "is" or "he" or "there" or "are" or "you" as why gift shop volunteer seems here.
...
Understand "go'inai" and "go'i nai" as saying no.
...
Rule for beat-producing when the current interlocutor is my mother:
	...
	otherwise if something portable which is not the player is on the futon:
...
Setting action variables for an actor clearing something:
	...
	repeat with item running through portable things which are not the player on the noun:
